...
public class ReplacePhoneActivity extends BaseActivity {
    ...
    public int initLayout() {
        return R.layout.act_replace_phone;
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_get_code:
                if ("获取验证码".equals(tvGetCode.getText().toString())) {
                    String phoneValue = tvTop.getText().toString();
                    ...
                    etCode.setText("");
                    sendCheckCode(tvTop.getText().toString());
                }
                break;
        ...
        OkClient.getInstance().post(map, new OkClient.EntityCallBack<BaseEntity>(context, BaseEntity.class) {
            ...
            public void onSuccess(Response<BaseEntity> response) {
                ...
                if ("00".equals(model.getStr39())) {
                    startActivity(new Intent(context, AddPhoneActivity.class));
                }
            }
        });
