    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_next:
                ...
                Intent intent = new Intent(context, DebitcardBindActivity.class);
            ...
            public void onResult(IDCardResult result) {
                if (result != null) {
                    ...
                    if (IDCardParams.ID_CARD_SIDE_FRONT.equals(idCardSide)) {
                        ...
                        uploadImage(BitmapManage.bitmapToString(filePath, 600, 600), "10E");
                    } else {
                        //反面
                        uploadImage(BitmapManage.bitmapToString(filePath, 600, 600), "10F");
                    }
                }
            }
