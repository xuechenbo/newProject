...
public class BenefitDetailActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        tvMoneyFrom.setText(CommonUtils.translateShortNumber(mBenefitModel.getMerchantCnName(), 1, 0));
        tvMoney.setText(mBenefitModel.getMoney().isEmpty() ? "0.00" : mBenefitModel.getMoney());
