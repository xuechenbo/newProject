package com.kotyj.com.activity.other;
...
public class QrCodePayActivity extends BaseActivity {
    ...
    private void requestData(final String money, String paytype, String type) {
        ...
        httpParams.put("13", getIntent().getStringExtra("level"));
        ...
        OkClient.getInstance().post(httpParams, new OkClient.EntityCallBack<BaseEntity>(context, BaseEntity.class) {
            ...
            public void onSuccess(Response<BaseEntity> response) {
                ...
                if ("00".equals(model.getStr39())) {
                    ...
                    ViewUtils.makeToast(context, "请扫描二维码", 1000);
...
//                loadingDialog.show();
    ...
    private void weixinShare() {
        ...
        sp1.setImagePath(Environment.getExternalStorageDirectory().getAbsolutePath() + "/xjej/qr.png");
    ...
    private void saveCurrentImage() throws IOException {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/xjej", "qr.png");
            if (!file.exists()) {
