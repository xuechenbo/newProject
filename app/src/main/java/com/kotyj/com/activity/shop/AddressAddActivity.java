...
import com.kotyj.com.viewone.wheelview.ChangeAddressPopwindow;
...
public class AddressAddActivity extends BaseActivity {
                ...
                mChangeAddressPopwindow.setAddresskListener(new ChangeAddressPopwindow.OnAddressCListener() {
                    ...
                    public void onClick(String province, String city, String area) {
                        ...
                        if (StringUtil.isEmpty(area)) {
                            diqu = province + "省" + "-" + city + "市";
                        } else {
                            diqu = province + "省" + "-" + city + "市" + "-" + area;
                        }
                        tvArea.setText(diqu);
                    }
                });
    ...
    private void requestModifyData() throws UnsupportedEncodingException {
        ...
        httpParams.put("12", checkbox.isChecked() ? "1" : "0");//是否默认地址 1默认 0非默认
