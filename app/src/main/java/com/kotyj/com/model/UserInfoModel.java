...
public class UserInfoModel implements Serializable {
    ...
    //todo  0：普通可以登陆APP的用户，1：开通了中介功能的APP用户，2：中介绑定的用户
    ...
    public String getIntermediarySwitch() {
        return intermediarySwitch;
    }

    public void setIntermediarySwitch(String intermediarySwitch) {
        this.intermediarySwitch = intermediarySwitch;
    }

    private String intermediarySwitch;
