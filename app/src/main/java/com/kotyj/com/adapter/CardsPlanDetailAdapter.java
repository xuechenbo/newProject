...
import com.kotyj.com.model.CardsBigPlanModel;
import com.kotyj.com.model.CardsSmallPlanModel;
...
//
        if (helper.getAdapterPosition() == 0) {
            if (mCardsBigPlanModel != null) {
                ...
                if (Integer.parseInt(mCardsBigPlanModel.getLevel()) >= 6) {
                    helper.tvLevelFee.setVisibility(View.GONE);
                } else {
                    ...
                    helper.tvLevelFee.setVisibility(View.VISIBLE);
                }
