...
public class DateUtil {
    ...
    private static SimpleDateFormat sdftwo = new SimpleDateFormat("MM-dd HH:mm");

    private static SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    private static SimpleDateFormat sdf11 = new SimpleDateFormat("yyyy.MM.dd HH:mm");
    private static SimpleDateFormat sdf123 = new SimpleDateFormat("yyyy.MM.dd");
    private static SimpleDateFormat sdf111 = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");

    private static SimpleDateFormat sdf12 = new SimpleDateFormat("yyyy年MM月dd日 HH:mm");
    ...
    private static SimpleDateFormat sdfYMD1 = new SimpleDateFormat("MM月dd号");
    ...
    public static String formatHMS(String date) {
        return formatDateToHM_points_s(parseDateToLong(date));
    }
    ...
    public static String formatDateToHM_point(long time) {
        return sdf11.format(time);
    }

    public static String formatDateToHM_points_s(long time) {
        return sdf111.format(time);
    }

    public static String formatDateToHM_(long time) {
    ...
    public static String formatDateToHMD3(long time) {
        return sdfYMD1.format(time);
    }
    ...
    public static String formatDate_Sdftwo(long time) {
        return sdftwo.format(time);
    }

    public static String formatDateYMD(long time) {
        return sdf123.format(time);
    }
