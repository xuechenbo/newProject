...
public class RegexUtil {
     ...
     * 验证密码 8-16 由数字和字母组合
     */
    public static boolean isPassWordLegal(Context context, String pwd) {
       // String regex1 = "([a-zA-Z0-9]){8,16}";
        String regex = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{8,16}$";
        boolean matches = Pattern.matches(regex, pwd);
        if (matches) {
            return true;
        } else {
            ViewUtils.makeToast(context, "密码要由8-16位数字和字母组合", 1200);
            return false;
        }
    }
