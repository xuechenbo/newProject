...
public class PermissionUtil {
    ...
    public static boolean getPermission(Activity activity) {
        boolean b = ActivityCompat.checkSelfPermission(activity, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED;
        boolean b1 = ActivityCompat.checkSelfPermission(activity, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED;
        if (b && b1) {
            ActivityCompat.requestPermissions(activity,
                    new String[]{Manifest.permission.READ_PHONE_STATE, Manifest.permission.CAMERA}, 105);
            return false;
        }
        return true;
    }
