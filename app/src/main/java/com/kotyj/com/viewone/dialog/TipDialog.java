...
import com.kotyj.com.activity.real.DebitcardBindActivity;
import com.kotyj.com.activity.real.RealNameFirstActivity;
...
public class TipDialog extends DialogFragment {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_admit:
                if ("auth".equals(type)) {
                    if (!aliAuth) {
                        mActivity.startActivity(new Intent(mActivity, RealNameFirstActivity.class));
                    } else {
                    ...
                    mActivity.startActivity(new Intent(mActivity, DebitcardBindActivity.class));
                    dismiss();
                } else if ("recertification".equals(type)) {
                    if (!aliAuth) {
                        mActivity.startActivity(new Intent(mActivity, RealNameFirstActivity.class).putExtra("isInfoComplete", true));
                    } else {
                        if (!PermissionUtil.CAMERA(mActivity)) {
                            return;
                        }
        ...
        OkClient.getInstance().post(httpParams, new OkClient.EntityCallBack<BaseEntity>(mActivity, BaseEntity.class) {
            ...
            public void onSuccess(Response<BaseEntity> response) {
                ...
                if ("00".equals(model.getStr39())) {
                    ...
                    ViewUtils.makeToast(mActivity, model.getStr38(), 1200);
                    mActivity.startActivity(new Intent(mActivity, RealNameFirstActivity.class));
                }
            }
    ...
    private void getCertificationResults(final Activity context, String ticketId) {
        ...
        OkClient.getInstance().post(httpParams, new OkClient.EntityCallBack<BaseEntity>(context, BaseEntity.class) {
            ...
            public void onSuccess(Response<BaseEntity> response) {
                ...
                if ("00".equals(model.getStr39())) {
                    StorageCustomerInfo02Util.putInfo(getActivity(), "freezeStatus", "10B");
                    StorageCustomerInfo02Util.putInfo(getActivity(), "idCardNumber", model.getStr36());
                    StorageCustomerInfo02Util.putInfo(getActivity(), "merchantCnName", model.getStr35());
                    startActivity(new Intent(getActivity(), DebitcardBindActivity.class));
                    dismiss();
                }
            }
    ...
    private void getTokensssssssssss() {
        loadingDialog.show();
        HttpParams httpParams = OkClient.getParamsInstance().getParams();
        httpParams.put("3", "190936");
        httpParams.put("21", merchanNo);
        OkClient.getInstance().post(httpParams, new OkClient.EntityCallBack<BaseEntity>(mActivity, BaseEntity.class) {
            ...
            public void onSuccess(Response<BaseEntity> response) {
                ...
                if ("00".equals(model.getStr39())) {
                    StorageCustomerInfo02Util.putInfo(getActivity(), "freezeStatus", "10B");
                    StorageCustomerInfo02Util.putInfo(getActivity(), "idCardNumber", "1111");
                    StorageCustomerInfo02Util.putInfo(getActivity(), "merchantCnName", "22222");
                    startActivity(new Intent(getActivity(), DebitcardBindActivity.class));
                    dismiss();
                } else if ("01".equals(model.getStr39())) {
                    StorageCustomerInfo02Util.putInfo(getActivity(), "freezeStatus", "10B");
