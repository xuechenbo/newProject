...
import com.kotyj.com.utils.DownloadUtil;
...
import com.kotyj.com.utils.okHttp.OkHttp3Util;
...
public class UpdateDialog extends DialogFragment {
    ...
    private void downFile(final String httpUrl) {
        ...
        OkHttp3Util.download(mActivity, httpUrl, "xjej.apk", new OkHttp3Util.OnDownloadListener() {
            @Override
    ...
    private void installApk() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri apkUri = FileProvider.getUriForFile(mActivity, "com.kotyj.com.fileprovider", mFile);
